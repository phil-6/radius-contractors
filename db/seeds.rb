...
phil = User.create!(email: "phil@purpleriver.dev", first_name: "Phil", last_name: "Reynolds", password: "test1234", password_confirmation: "test1234", town: "Swansea", confirmed_at: Time.current)
calum = User.create!(email: "calum@mcclune.me", first_name: "Calum", last_name: "McClune", password: "test1234", password_confirmation: "test1234", town: "Swansea", confirmed_at: Time.current)
tom = User.create!(email: "tomofstephens@gmail.com", first_name: "Tom", last_name: "Stephens", password: "test1234", password_confirmation: "test1234", town: "Swansea", confirmed_at: Time.current)
ciaran = User.create!(email: "ciaran_browning@hotmail.co.uk", first_name: "Ciaran", last_name: "Browning", password: "test1234", password_confirmation: "test1234", town: "Swansea", confirmed_at: Time.current)
jon = User.create!(email: "Jon.r.twigg@gmail.com", first_name: "Jon", last_name: "Twigg", password: "test1234", password_confirmation: "test1234", town: "Swansea", confirmed_at: Time.current)
suz = User.create!(email: "s-k-t@hotmail.co.uk", first_name: "Suzanne", last_name: "Thomas", password: "test1234", password_confirmation: "test1234", town: "Swansea", confirmed_at: Time.current)
